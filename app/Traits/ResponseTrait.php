...
trait ResponseTrait
{
    ...
    public function returnExtractPDF($key, $rating, $errors, $skills, $experience, $msg = '')
    {
        return response()->json([
            $key => [
                'status' => true,
                ...
                'grammar_vocabulary_errors' => $errors,
                'msg' => $msg,
            ]
        ]);
    }
    ...
    // ?todo return error for Payments Process 
    public function ErrorsPayments($msg)
    {
        return response()->json([
            'status' => false,
            'errNum' => "500",
    ...
    // ?todo return error for Payments Process 
    public function responseErrors($msg)
    {
        return response()->json([
            'status' => false,
            'errNum' => "500",
